...
pub fn map_profile(profile: Profile, groups: Vec<u64>, events: Vec<u64>) -> ProfileWithRefs {
    ProfileWithRefs {
        ...
        privacy: Privacy {
            privacy_type: match profile.privacy {
                catalyze_shared::profile_privacy::ProfilePrivacy::Private => PrivacyType::Private,
